...
def get_args(in_args):
    ...
    parser.add_argument('--strategy', type=str, default='standard', help='exploration strategy')
    ...
    parser.add_argument('--noisy', type=int, default=0, help='enable noisy parameter estimation')
    parser.add_argument('--polyak', type=float, default=0.95, help='the average coefficient')
    parser.add_argument('--n-test-rollouts', type=int, default=10, help='the number of tests')
    parser.add_argument('--clip-range', type=float, default=5, help='the clip range')
    parser.add_argument('--epsilon', type=float, default=0.1, help='variable for e-greedy')
